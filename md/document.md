...
Exidiophoneの演奏において、絶えずインタラクションが発生し、その演奏についての記述が難しいゆえに楽譜にあたるものの制作がほぼ不可能だったことを振り返り、逆に
...
クセナキスとかではなく、言語やアナロジー、視覚的要素とは別に同じように時間シーケンスを再現する方法についての興味　楽器自体が音を保存しているという考え　言語が音を記述するのではない
