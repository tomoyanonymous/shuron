...
一方でオーディオフィードバックを積極的に芸術作品や音楽の中に取り入れる試みも数多くなされている[@Eck2017]。現代音楽の分野ではRobert Ashleyの*The Wolfman*で初めて用いられたほか、Steve Reich*のPendulum Music*などが代表例としてあげられる。

Sanfilippoらはフィードバックシステム（ここではオーディオフィードバックに限っていない）の特徴を

のようにあげ、フィードバックシステムを用いた作品の分析の枠組みを図nのように捉えている[@sanfilippo2013feedback]。図の説明
