...
また、はならぁとの展示では比較的厳密に元のモデルとの対応関係が守られていたものの、NIMEの展示では一対一にパラメーターが対応しているとも言えない部分が増えていった。それに加えて展示を繰り返すうちに、実装にいくつかの選択肢がある時の判断基準として“Whirlwindらしくする”よりも“Aphysical Unmodeling Instrumentというより抽象的なシステムらしくする”意識への変化があったように思う。出音が実際の管楽器らしさであるかどうかが徐々に重要でなくなっていった。その抽象化の一方でマイクとスピーカーの位置関係という制約は4作品できちんと守り通されている。この変化はBorinの物理モデルはあくまで発想の元でしかない、という言い方と一致するように思う。
