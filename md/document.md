...
彼はレコードプレイヤーの再発明や、炎を音声再生のメディウムとして用いる装置などを細かなリサーチをもとにして制作するが、こうした研究は装置の調査だけにとどまらず、例えば近年の作品『Jiffy Pop(2014)』『Timpanic Array(2015)』では人間の聴覚系とそれに関連する脳活動に関するリサーチをもとに作ってもいる。(http://pauldemarinis.org/TympanicJiffy.html)
...
ここまで3作品の制作の過程とそれに基づく個別の考察を行ってきた。本章ではそれぞれの考察の内容を並列し改めて検討していく。
